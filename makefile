...
spec_ldflags +=	$(_flagdiv_)arch_win32 -static-libgcc -static-libstdc++ -mconsole -lmingw32
spec_ldflags +=	$(_flagdiv_)arch_win64 -static-libgcc -static-libstdc++ -mconsole -lmingw32
